      ...
      <el-card id='card2'>
          <el-form label-width='80px'>
              <el-form-item class='form_item' label='昵称' >
                      <el-input class='input' v-model='name' placeholder="请输入昵称" suffix-icon="el-icon-edit"></el-input>
              </el-form-item>
              ...
              <el-form-item>
                      <el-button id='button1' type='primary' @click='register'>注册</el-button>
    ...
    methods:{
       ...
       getyzm()
       {
          ...
          else if(!reg.test(this_email))
          {
             ...
             this.$axios({
             method: "post",
             url: "http://121.89.166.24:8080/register/yzm", // 接口地址
        ...
        register()
       {
          ...
          else if(this_name.length > 10)
          {
            this.$alert('昵称不能超过10位！', '', {
                        confirmButtonText: '确定',
                        center:true,
                      });
          }
          ...
          else if(this_id.length < 6 || this_id.length > 20)
          {
            this.$alert('账号不能小于6位或者大于20位！', '', {
                        confirmButtonText: '确定',
                        center:true,
                      });
          }
           ...
           else if(this_yzm=='')
          {
            ...
            // },
            url: "http://121.89.166.24:8080/register", // 接口地址
            withCredentials: "true",
            params: {
               user: this_id ,  // 传接口参数
               pwd: this_password,
