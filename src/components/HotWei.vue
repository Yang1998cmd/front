...
<el-container>
  ...
  <el-main id='main'>
    <el-col >
      <el-card id='card'>
          <el-avatar :size="80" :src="dat.headImg" style="cursor: pointer" @click.native="TurnToOwn(dat.id)"></el-avatar>
          <div class='author_div'>{{dat.name}}</div>
